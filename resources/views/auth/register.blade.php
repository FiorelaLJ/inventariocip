...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="background-color: #d34848">{{ __('Registrarse') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="Radio" name="rol" value="Administrador" required>Administrador &nbsp
                                <input type="Radio" name="rol" value="Jefe de Inventario" required>Jefe de Inventario &nbsp
                                <input type="Radio" name="rol" value="Encargado de Inventario" required>Encargado de Inventario
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="Radio" name="estado" value="Habilitado" required>Habilitado &nbsp
                                <input type="Radio" name="estado" value="Deshabilitado" required>Deshabilitado
